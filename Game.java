...
{   
   ...
   private String[] soalA = {"Zaki" ,"Dicky"   ,"Renaldy"     , "Wahyu"      , "Helmi"   , "Agusta"          , "Dany"  , "Dicky"     , "Agusta"     , "Wahyu"   , "Ody"      , "Renaldy"     , "Ody"         , "Wahyu"};
   private String[] soalB = {"Odi" ,"Grandis" ,"Dimas"       , "Odi"         , "Grandis" , "Dany"            , "Dhimas"  , "Zaki"      , "Helmi"      , "Helmi"   , "Pres"     , "Zaki"    , "Son"        , "Greg"}; 
   private String[] soalC = {"Wahyu" ,"Odi"     ,"Agus"        , "Agusta"        , "Son"     , "Helmi"           , "Dicky"  , "Dimas"     , "Grandis"    , "Agus"    , "Zaki"     , "Wahyu"   , "Grandis"     , "Zaki"};
   private String[] soalD = {"Dicky" ,"Zaki"    ,"Agusta"      , "Dany"        , "Agus"    , "Agusta"          , "Ody"   ,"Wahyu"      , "Ody"        , "Grandis" , "Son"      , "Helmi"   , "Zaki"        , "Agus" };
